...
RECON = Mission(
    ...
    beats=(
        ...
        (60, "Repeater on: GPS +8 dB, 300 m of extra path. Believed position dragged toward the emitter."),
        (61, "GPS is the odd constellation out: all 12 dropped. Information ratio 0.72. DEGRADED, reweight toward Galileo."),
        (75, "Halt at OP-1. Stationary: the fix still drags. The drag vector is the spoof and points at the emitter."),
        (85, "Anchored on the zero-velocity fix. Corrected position on Galileo within 1 m. Report filed with emitter bearing."),
        (150, "Repeater off. GPS readmitted after its clock channels re-agree."),
        (390, "Authorisation renewed: key disclosed, uplink solid."),
        (461, "Loop complete. Every report delivered with a trust tag."),
    ),
    behaviour={
...
CASEVAC = Mission(
    ...
    beats=(
        ...
        (60, "Carry-off begins, code and carrier coherent. Signal strength blips for one epoch."),
        (61, "Ranges no longer fit one position: six satellites distrusted; believed 7.6 m ahead of truth."),
        (70, "Believed position enters ground the map calls a different class; the wheel sensor disagrees. Terrain mismatch fires."),
        (80, "The believed pin enters the collection-point ring. The vehicle is 240 m short. Arrival NOT confirmed."),
        (95, "Sensor crosses the mapped boundary: arc length pinned. Terrain-referenced fix within one cell of truth."),
        (176, "AT CCP, confirmed on a fix ARBITER stands behind."),
